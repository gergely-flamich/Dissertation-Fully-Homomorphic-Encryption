...
\begin{definition}{(Informal) Functionally complete set:}
  Let $\Gamma$ be a set of boolean gates, such that every gate in the set is a
...
lattices. 
\subsubsection{Definitions and Approach}
...
permitted circuits $\Sigma_\Pi'$, as defined in Definition \ref{def:perm_circuits}
