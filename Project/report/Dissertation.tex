...
the powers of $x$. The highest power of $x$ is the \textit{degree} of the
...
\begin{proof}
  ...
  \times p(x)$. In particular, we will thus have integers $a_1, \hdots a_n$ such that
  \[
    q(x) = \sum_{i = 1}^n a_ip(x)x^i \mod f(x)
